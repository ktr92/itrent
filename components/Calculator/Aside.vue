<template>
  <div id="proposal-list">
    <div class="fixed  pb-24 md:pb-0 overflow-x-hidden overflow-y-scroll md:overflow-auto top-0 w-full min-h-screen h-full bg-white z-50 md:static md:min-h-auto md:w-auto md:h-auto md:block" :class="[show ? 'block' : 'hidden']">
      ...
      <div class="px-3.5 md:px-2">
        ...
        />
        <div v-if="getReady" class="mt-2 md:pb-4">
